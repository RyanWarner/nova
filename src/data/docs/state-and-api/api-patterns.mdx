...
Nova is built for [REST](https://en.wikipedia.org/wiki/Representational_state_transfer) APIs. It can be modified to accomodate any data fetching technique, but there is tooling and helpers to make getting started with REST quick and easy.
